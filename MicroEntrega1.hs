...
dividirAcumuladores unMicrocontrolador | (b unMicrocontrolador) == 0 = unMicrocontrolador {etiqueta = "ERROR DIVISION BY ZERO"} | otherwise =  unMicrocontrolador { a = quot (a unMicrocontrolador) (b unMicrocontrolador), b = 0} 
